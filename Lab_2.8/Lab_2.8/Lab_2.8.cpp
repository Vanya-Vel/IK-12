...
// – складніші завдання.Обчислення кількості об’єктів
// Варіант 0.4
...
int main() {
    ...
    Bankomat atm(atmID, minAmount, maxAmount);
    ...
    atm.displayBalance();
    atm.displayBalanceInWords();  // Баланс після зняття в букв. форматі

    // Копіювання банкомату за допомогою копіювального конструктора
    Bankomat atmCopy = atm;  // Це викликає копіювальний конструктор
